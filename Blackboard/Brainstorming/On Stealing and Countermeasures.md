...
>
>Each Lookout guarding a Player can thwart 1 Malicious Attempt by a Criminal at the cost of 1 of their Lookout Charges, forcing the Player into a Protected status for some duration. While the player is Protected, Malicious Attempts cannot be made on them. Once the The Lookout is immediately sent back to the Officer to be freely dispatched again the moment the Player.
>
>
