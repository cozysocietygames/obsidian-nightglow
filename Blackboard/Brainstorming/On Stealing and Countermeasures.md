...
> 
> * Raising a Target's Markedness to (`markedness`=1,2,3) takes about **`markedness`h** and upon completion, accumulates **`stakeoutt`h** of Stakeout.
> 
...
>
>If the Stealing Timer finishes completely, the Stolen Goods becomes a Hot Goods, and a Hot Goods timer is started. A Hot Goods Timer starts at **`hotgoodst=12?`h** and is reduced by any amount of Accumulated Stakeout **`stakeoutt`h**.
>
