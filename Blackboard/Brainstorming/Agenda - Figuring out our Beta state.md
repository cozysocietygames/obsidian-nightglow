...
Prioritizing rendering Town and City Maps allows the Government to be fully functional early on as opposed to only having one or two working cities for a long time. As for traveling between them, we can Alakazam players across them. 
