...
>A player may hire an Officer to guard them preemptively. The Officer dispatches a number of Pokemon to each serve as Lookouts for the player. Each Lookout can have three states: *Guarding*, *Distracted*, or *Fatigued*. Each Lookout only remains active for 1h. (The second Lookout only starts when the first Lookout is )
>
>### Guarding
