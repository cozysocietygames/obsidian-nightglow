...
> 
> * Raising a Target's Markedness to (so`=1,2,3) takes about **xh** and upon completion, accumulates **x'h** of Stakeout.
> 
...
>
>If the Stealing Timer finishes completely, the Stolen Goods becomes a Hot Goods, and a Hot Goods timer is started. A Hot Goods Timer starts at **y'h** and is reduced by any amount of Accumulated Stakeout **x'h**.
>
